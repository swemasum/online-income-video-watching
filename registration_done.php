...
$date=date("Y-m-d");
  $sql = "INSERT INTO user(name,address,phone_no,email,bd_no,password,date,status,payment_type,	security_ans, ref_num,reg_payment_type,txid,ref_id	)
VALUES ('$name', '$address', '$phone_no','$email','$bd_no','$password','$date','pending','$payment_type','$pet','$randomString','$reg_payment_type','$txid','$ref_id')";
...
mysqli_close($conn);
       ...
       header("Location:index.php");
        ...
        <div class="card-body">
          ...
          <p class="card-text">Thanks for your Request. Now, your status is "pending". Admin, will check your request. You can LOG IN Using your email:<?php echo $email?> and Password.</p>
