		...
		<div class="col-12 col-md-8 col-lg-6 pb-5">
                    ...
                    <form action="changepass.php" method="post">
                        <div class="card border-primary rounded-0">
                            ...
                            <?php
                               if(isset($_GET["mess"])){
																 ECHO "<strong style='color:red'>***Wrong email/pet name </strong>";
															 }
														 ?>
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text"><i class="fa fa-paw text-info">What is your favourite pet?</i></div>
                                        </div>
                                ...
                                <div class="text-center">
                                    <input type="submit" name="login" value="Go ->" class="btn btn-info btn-block rounded-0 py-2">
