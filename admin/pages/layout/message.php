                ...
                include_once "../../../connection.php";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      while($row = mysqli_fetch_assoc($result)) {
                        echo "<tr class='info'>";
                          echo "<td>" . $row["name"]."<br>Email: ".$row["email"]."<br>Subject: ".$row["subject"]."</td>";

  echo "<td> " . $row["message"]."</td>";
  echo "<td> " . $row["status"]."</td>";
                          echo '<td><a href="delete_message.php?id='.$row['m_id']. '"class="btn btn-info btn-lg">
          <span class="glyphicon glyphicon-remove"></span>
        </a>
        <a href="change_status_message.php?id='.$row['m_id']. '"class="btn btn-info btn-lg">
