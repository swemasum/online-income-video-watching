...
echo $batch_id;
$sql = "SELECT * FROM exam_no where batch_id='$batch_id' order by exam_no desc limit 1";
$result = mysqli_query($conn, $sql);
$last_exam=0;
if (mysqli_num_rows($result) > 0) {
    // output data of each row
    while($row = mysqli_fetch_assoc($result)) {
        $last_exam=$row['exam_no'];
    }
} else {
    echo "0 results";
}
$last_exam++;
          ...
          $sql = "INSERT INTO exam_no (batch_id,exam_no)
          VALUES ('$batch_id', '$last_exam')";
          echo $sql;
          $result = mysqli_query($conn, $sql);


          $sql = "SELECT * FROM exam_no order by en_id desc limit 1";
          $result = mysqli_query($conn, $sql);

          if (mysqli_num_rows($result) > 0) {
              // output data of each row
              while($row = mysqli_fetch_assoc($result)) {
                $_SESSION['last_exam']=$row['en_id'];
              }
          } else {
              echo "0 results";
          }
...
<div class="col-md-10 col-lg-10">
        ...
        <div class="col-lg-12 col-md-12 " style="padding:10px;border:1px solid #9C9C9C;margin:5px;border-radius:10px;">
                   ...
                   <form action="exam_name.php" method="post" enctype="multipart/form-data">
        <div class="row">

          <div class="col-lg-10 col-md-10">
            <div class="form-group">
              <label for="pwd">new Exam name:</label>
              <input type="text" maxlength="55"  onpaste="return false"  name="name" class="form-control" id="pwd">
            </div>
            <div class="form-group">
              <label for="pwd">select Exam name:</label>

              <select  class="form-control" name="selected_name">

                <?php
                $sql = "SELECT DISTINCT exam_name FROM exam_no order by en_id desc";
                $result = mysqli_query($conn, $sql);
          ...
          <div class="col-lg-10 col-md-10">
            <div class="form-group" >
              ...
              <textarea class="form-control" name="short_description" rows="2" cols="80">
 ...
 <input type="submit" style="margin-top:26px" name="submit" value="Submit"  class="btn btn-danger">
