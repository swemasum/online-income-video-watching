...
<div class="col-md-4 col-lg-4">
        ...
        <div class="col-lg-4 col-md-4 " style="padding:10px;border:1px solid #9C9C9C;margin:5px;border-radius:10px;">
                <form  action="cre_done.php" method="post">
        <div class="row">
              ...
              include_once "../../../connection.php";
                  ...
                  $sql = "SELECT * FROM current_student where batch_id=$batch_no ";
                  $result = mysqli_query($conn, $sql);
                  $students=0;
                  $_SESSION['student']=array();
                  $_SESSION['student_new']=array();
                  if (mysqli_num_rows($result) > 0) {
                    // output data of each row
                    while($row = mysqli_fetch_assoc($result)) {
                      $student_id=$row['current_student_id'];
                      $sql2 = "SELECT cre,mcq FROM result where current_student_id='$student_id 'and exam_no='$exam_no'";
                          $result2 = mysqli_query($conn, $sql2);
                          $students++;
                          $roll=$row["current_student_id"];
                          ...
                          if (mysqli_num_rows($result2) > 0) {
                            ...
                            $mcq='';
                                                                               ...
                                                                               if($cre!='' || $mcq=''){
                                                                                 array_push($_SESSION['student'],$roll);
                                                                                echo "<br>old roll:".$roll;

                                                                             }else{
                                                                               array_push($_SESSION['student_new'],$roll);
                                                                               echo "<br>new roll:".$roll;

                                                                             }

                      echo '<div class="col-lg-8 col-md-8">';
                        echo '<div class="input-container">';
                        echo "  <i class='fa  icon'>" . $row["roll"]."</i>";
                       echo '<input class="input-field" type="number" placeholder="marks" value="'.$cre.'" name="'. $row["current_student_id"].'">';
                        echo '</div>';
                        echo '</div>';
          ...
          <div class="col-md-8 col-lg-8">
            <button style="margin-top:26px" type="submit" value="submit" name="submit" class="btn btn-danger">submit</button>
