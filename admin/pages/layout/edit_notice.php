...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../admin.php" class="logo">
      ...
      <span class="logo-mini"><b>C</b>HEM</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>CHEM</b>TOR</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    $sql = "SELECT * FROM notice where n_id='$id'";
     ...
     $(function(){
       $('#txt,#notice').keypress(function(e){
...
<div class="col-md-10 col-lg-10">
        ...
        <div class="col-lg-12 col-md-12 " style="padding:10px;border:1px solid #9C9C9C;margin:5px;border-radius:10px;">
                   ...
                   <form action="update_notice_done.php?" method="post" enctype="multipart/form-data">
        <div class="row">

          <div class="col-lg-10 col-md-10">
            <div class="form-group">
              <label for="pwd">Title:</label>
              <input type="text" maxlength="60" value="<?php echo $title ?>" id='txt' value='' onpaste="return false"  name="title" class="form-control">
            </div>
          </div>
          ...
          <div class="col-lg-10 col-md-10">
            <div class="form-group">
              ...
              <textarea class="form-control" value="" name="notice" rows="8" cols="80" id='notice' value='' onpaste="return false">
                <?php echo $notice ?>
              </textarea>
            </div>
          </div>
