    ...
    <section class="content">
      <div class="row" >
        ...
        <div class="col-lg-12 col-md-12 " style="padding:10px;border:1px solid #9C9C9C;margin:5px;border-radius:10px;">
                <form  action="renew_payment_done.php" method="post">
              ...
              <div class="row">
                ...
                <div class="col-md-4 col-lg-4">
                  <div class="form-group" id="man_cont"  style="display:none">
                    <button style="margin-top:26px" type="submit"  class="btn btn-info">Renew payment</button>
                </div>
            ...
            <thead>
              ...
              <?php
                include_once "../../../connection.php";
                    ...
                    $sql = "SELECT * FROM renew order by r_id desc";
...
$i=0;
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      while($row = mysqli_fetch_assoc($result)) {
                        echo "<tr class='info'>";
                          if($i==0){
                            $last_date= $row["date"];
                               echo "Last Renew date:: ".$last_date;
                            $i=$i+1;
                          }
                          echo "<td>" . $row["r_id"]."</td>";
                          echo "<td>" . $row["date"]."</td>";
          ...
          order();
                  function order() {
                    var last_date = "<?php Print($last_date); ?>";
                    var d = new Date();
                    var n = d.getMonth()+1;
                    var month=last_date.split("-");
                console.log(n);
                console.log(month[2]);
                    if ( n > month[2]) {
