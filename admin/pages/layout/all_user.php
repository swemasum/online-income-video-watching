  ...
  <div class="content-wrapper">
   ...
   <!-- /.box -->
        ...
        <div class="box">
                  ...
                  include_once "../../../connection.php";
                      ...
                      if (mysqli_num_rows($result) > 0) {
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                          echo "<tr class='info'>";
                          echo "<td>".$row["u_id"]."</td>";
                          echo "<td> Reference id: ". $row["ref_num"]."</br>". $row["name"]."<br>Address:".$row["address"]."<br>Phone:".$row["phone_no"]."</td>";
                          echo "<td>Type: " . $row["reg_payment_type"]."<br>TxID: ".$row["txid"]."</td>";
          ...
          <a href="edit_student.php?id='.$row['u_id']. '"class="btn btn-info btn-lg">
  <span class="glyphicon glyphicon-pencil"></span>
  </a>
  <a onclick="return check();" href="delete_user.php?id='.$row['u_id']. '"class="btn btn-info btn-lg">
