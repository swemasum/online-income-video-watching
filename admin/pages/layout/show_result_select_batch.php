  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="	fa fa-bullhorn"></i> <span>Add</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
...
<div class="row">
  <div class="col-md-3">
<form class="" action="show_result_select_batch.php" method="post">
    ...
    <input type="submit" class="btn btn-danger" name="go" value="show">
    </form>
<a style="margin-top:5px;width:58px"   class="btn btn-primary" onclick="PrintElem('myDivToPrint')"> PDF </a>
  ...
  <div class="col-md-9" id="myDivToPrint">
    <?php
      if(isset($_POST['go'])){
        echo '<label for="pwd">'. $_POST['selected_name'] .'</label>';
                ...
                <thead>
                  ...
                  if(isset($_POST['go'])){
                    ...
                    include_once "../../../connection.php";
                        ...
                        $sql = "SELECT DISTINCT current_student.roll,result.current_student_id,current_student.s_name,current_student.college,result.cre,result.mcq,(result.cre+result.mcq) as total
FROM result
left join
