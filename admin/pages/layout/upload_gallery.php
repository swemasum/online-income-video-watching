...
<div class="col-md-10 col-lg-10">
        ...
        <div class="col-lg-12 col-md-12 " style="padding:10px;border:1px solid #9C9C9C;margin:5px;border-radius:10px;">
                   ...
                   <form action="upload_gallery_done.php" method="post" enctype="multipart/form-data">
        <div class="row">

          <div class="col-lg-10 col-md-10">
            <div class="form-group">
              <label for="pwd">Title:</label>
              <input type="text" maxlength="55"  onpaste="return false"  name="title" class="form-control" id="pwd">
            </div>
          </div>
          <!--
          <div class="col-lg-10 col-md-10">
