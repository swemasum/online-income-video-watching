                ...
                <div class="row">
                  <div class="col-lg-5 col-md-5">
                    <div class="form-group">
                      ...
                      <input required type="text" class="form-control" name="title" id="name">
                    </div>
                  </div>
                  <div class="col-lg-5 col-md-5">
                    <div class="form-group">
      ...
      $(".image-preview-input input:file").change(function (){
          ...
          reader.readAsDataURL(file);
                    ...
                    .container{
                       ...
                       <label for="email">Video thumbnail:(<span style="font-weight:bold;color:red">UP TO 2MB</span>)</label>
                  ...
                  <div class="col-md-12 col-lg-12">
                    <div class="form-group">
                      <label for="pwd">Pest embaded link:</label>
                        <textarea name="link" rows="3" style="width:100%"></textarea>
                      </div>
                  </div>
                </div>
