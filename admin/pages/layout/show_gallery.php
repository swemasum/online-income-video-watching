...
<div class="wrapper">
 ...
 <section class="content">
   ...
   <div style="height: 500px; overflow-y: scroll; overflow-x: scroll;" class="table-wrapper-scroll-x">
     <table class="table">
         <thead>
           ...
           <?php
             include_once "../../../connection.php";
                 ...
                 $sql = "SELECT * FROM gallery order by g_id asc";
                 ...
                 if (mysqli_num_rows($result) > 0) {
                   ...
                   while($row = mysqli_fetch_assoc($result)) {
                     echo "<tr class='info'>";
                       ...
                       echo "<td>" . $row["date"]."</td>";
                       echo '<td> <img  STYLE="max-height:200px;max-width:300px" src="gallery/'.$row["image_name"].'"</td>';

                       echo '<td>
                       <a  href="upload_gallery.php?g_id='.$row['g_id']. '"class="btn btn-primary btn-xs">
       <span class="glyphicon glyphicon-pencil" > Edit</span>
     </a>
                       <a onclick="return check();" href="delete_gallery.php?g_id='.$row['g_id']. '"class="btn btn-primary btn-xs">
