            ...
            <thead>
              ...
              <?php
                include_once "../../../connection.php";
                    ...
                    $sql = "SELECT * FROM batch where status='running' and type='Model Test' order by batch_no desc";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      while($row = mysqli_fetch_assoc($result)) {
                        echo "<tr class='info'>";
                          ...
                          echo '<td><a href="result_select_exam_no.php?id='.$row['b_id']. '"class="btn btn-primary btn-xs">
          <span class="glyphicon glyphicon-pencil">Go</span>
        </a>
