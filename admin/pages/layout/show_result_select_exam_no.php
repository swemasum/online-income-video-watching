    ...
    <section class="content">
      ...
      <div class="table-wrapper-scroll-x">
        <table class="table">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      while($row = mysqli_fetch_assoc($result)) {
                        echo "<tr class='info'>";
                          ...
                          echo '<td><a href="show_result.php?exam_no='.$row['exam_no']. '"class="btn btn-primary btn-xs">
                              <span class="glyphicon glyphicon-eye-open" > Show</span>
                            </a>
          ...
          <a href="show_result.php"class="btn btn-primary btn-xs">
              <span class="glyphicon glyphicon-eye-open" > Show Final result</span>
            </a>
