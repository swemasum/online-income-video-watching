...
if (mysqli_num_rows($result) > 0) {
   ...
   while($_row = mysqli_fetch_assoc($result)) {
       ...
       $status = $_row['status'];
$payment_type = $_row['payment_type'];
    ...
    <div class="container" >
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-6">
                      <div class="form-group">
                        ...
                        <input required type="text" class="form-control" value="<?php echo  $s_name;?>" name="name" id="name">
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                      <div class="form-group">
                        <label for="nick_name">address:</label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" max="01999999999"  name="phone_no" value="<?php echo  $phone_no ;?>" placeholder="01xxx-xxxxxx" class="form-control" id="pwd">
                      </div>
                    </div>
      ...
      <hr>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="pwd">payment no:</label>
                    <input required type="text" max="01999999999"  name="bd_no" maxlength="11" value="<?php echo $bd_no  ; ?>"  placeholder="01xxx-xxxxxx" class="form-control" id="pwd">
                  </div>
                </div>
                <div class="col-md-6 col-lg-6">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="email" name="email"  required value="<?php echo $email  ; ?>" class="form-control" placeholder="example@gmail.com" id="pwd">
                  </div>
                </div>
                <div class="col-md-6 col-lg-6">
                  <div class="form-group">
                    <label for="pwd">password:</label>
                    <input  type="text" name="password" required value="<?php echo $password   ; ?>" class="form-control"  id="pwd">
                  </div>
                </div>
      ...
      <hr>
              ...
              <button style="" type="submit" name="submit"  class="btn btn-danger">Edit</button>
