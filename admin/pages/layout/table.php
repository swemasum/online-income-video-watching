                    ...
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      while($row = mysqli_fetch_assoc($result)) {
                        echo "<tr class='info'>";
                          ...
                          echo '<td><a href="accept.php?id='.$row['u_id']. '&ref='.$row['ref_id'].'"class="btn btn-info btn-lg">
          <span class="glyphicon glyphicon-ok">

          <a onclick="return check();" href="delete.php?id='.$row['u_id']. '"class="btn btn-info btn-lg">
