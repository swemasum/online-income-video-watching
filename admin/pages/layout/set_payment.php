    ...
    <section class="content">
      <div class="row" >
        ...
        <div class="col-lg-12 col-md-12 " style="padding:10px;border:1px solid #9C9C9C;margin:5px;border-radius:10px;">
                <form  action="set_payment_done_final.php" method="post">
        ...
        <div class="col-md-6">
          ...
          <div class="col-lg-4 col-md-4">
            <div class="form-group">
              <label for="pwd">Update amount for per video watching(TK):</label>
              <input type="number" name="amount"  step=0.01 class="form-control" id="pwd">
            </div>
          </div>
          <div class="col-md-4 col-lg-4">
            <button style="margin-top:26px" type="submit"  class="btn btn-info">Submit</button>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          ...
                          while($row = mysqli_fetch_assoc($result)) {
                            ...
                            /*  echo "<td>" . $row["shift"]."</td>";
                              echo "<td>" . $row["date"]."</td>";
                              echo "<td>" . $row["amount"]."</td>";
                              echo '<td><a href="set_payment_delete.php?id='.$row['ps_id']. '"class="btn btn-info btn-lg">
        ...
        <div class="col-md-6">
          ...
          <div class="col-lg-4 col-md-4">
            <div class="form-group">
              <label for="pwd">Referred Amount(TK):</label>
              <input type="number" name="reg_amount"  step=0.01 class="form-control" id="pwd">
            </div>
          </div>
          <div class="col-md-4 col-lg-4">
            <button style="margin-top:26px" type="submit"  class="btn btn-info">Submit</button>
