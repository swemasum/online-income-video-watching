...
<div class="row" style="margin-top:5px;margin-bottom:5px">
  <div class="col-md-2">
 <h4 style="color:red">must watch for 2 minutes</h4>
  ...
  <div class="col-md-8">
    <div class="embed-responsive embed-responsive-16by9">
          ...
          echo '<iframe width="560" height="315"  src='.$newstr.'frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
						    }
				} else {
				    echo "0 results";
				}
  ...
  <div class="col-md-2">
     <h4 style="color:red">Wait for confirmation</h4>
  </div>
  <input type="hidden" name="" value="<?php echo $_SESSION['user']; ?>" id="user_id">
      <input type="hidden" name="" value="<?php echo $v_id; ?>" id="v_id">
</div>
	<!-- //map -->
	<!-- /contact -->
  <div class="copy">
...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/12-03-2018/stereo-demo_Free/1055858451/web/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Dec 2018 07:51:35 GMT -->
 ...
 <script type="text/javascript">
   setTimeout(function(){alert("Saved into database your watched list.")},125000);
 </script>
